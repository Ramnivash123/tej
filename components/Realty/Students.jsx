...
import {
  getFilteredPropertiess,
  getMetroEn,
  getPropertyfromMetroEn,
...
const Students = () => {
  ...
  const handleSearch = (e) => {
    ...
    let data = [];
    metros.map((metro) => {
      if (String(metro).toLowerCase().includes(searchterm.toLowerCase())) {
        data.push(metro);
      }
    });
    setSuggestions(data);
  ...
  useEffect(() => {
    const fetch = async () => {
      const res = await getPropertyfromMetroEn(metro);
      setProperties(res);
      setSuggestions([]);
    };
    fetch();
  ...
  return (
    <div>
      ...
      <main className="lg:px-10 px-5 pt-16 pb-10 ">
        <section className="portalmain rounded-3xl w-full lg:h-[300px] h-[180px] lg:px-10 px-5 py-5 text-white mt-10">
          ...
          <h5 className="lg:text-xl mt-3 w-fit rounded-xl montserrat bg-[#dad5e7] text-black px-3 py-1">
            {lang === "en" ? (
        ...
        <div className="lg:mt-[-100px] mt-[-40px] lg:px-8 px-3">
          <section className=" grid-cols-7 lg:grid  gap-5 w-full">
            <div className="col-span-5">
              <div className=" lg:rounded-xl lg:bg-gray-100 relative z-[2] lg:p-5">
                <div className="flex gap-5 bg-gray-100 p-2 rounded-xl items-center w-full ">
              ...
              <div className="grid gap-5 pt-5">
                ...
                >
                  <div className="flex flex-col h-full justify-between ">
                    ...
                    <div className="bg-white w-full text-xl font-semibold py-2 text-center rounded-b-xl">
                      <h5 className="">
                        {lang === "en" ? (
                          <span>Properties nearby metro station</span>
                        ) : lang === "ge" ? (
