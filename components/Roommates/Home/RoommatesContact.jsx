...
const RoommatesContact = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post(`${API}/send-email-roommates-req`, {
        name,
        email,
        phone,
      });
  ...
  return (
    <div>
      <main className="bg-gray-800 relative z-[2] mt-5 overflow-hidden">
        <section className="lg:px-20 px-10 py-10">
          <motion.div
            initial={{ opacity: 0, scale: 0.9, x: -100 }}
            whileInView={{ opacity: 1, scale: 1, x: 0 }}
            transition={{ type: "spring", stiffness: 200, damping: 50 }}
            className="text-white max-w-[450px] hidden lg:block"
          >
          ...
          <motion.div
            ...
            transition={{ type: "spring", stiffness: 200, damping: 50 }}
            className="text-white max-w-[450px] lg:hidden"
          >
            <h1 className="text-2xl mont font-bold">Contact</h1>
            <h5>
            ...
            <div className=" bg-blue-50 max-w-[500px] m-auto rounded-2xl lg:px-20 px-10 py-10 mt-5">
              <form action="" onSubmit={handleSubmit}>
                ...
                <div className="grid gap-5 place-items-center text-black  ">
                  ...
                  <input
                    type="submit"
                    value="Submit"
                    className="bg-gray-800 w-full text-white py-2 rounded-xl mt-5"
                  />
                </div>
              </form>
            </div>
        ...
        <section className="grid  lg:grid-cols-2">
          <div className="lg:flex grid order-2 lg:order-1">
            <div className="lg:max-w-[100px] flex lg:flex-col lg:gap-10 gap-20 order-2 lg:order-1 justify-center lg:justify-end py-20 px-10 text-white text-xl">
              <motion.div
            ...
            <div className="flex justify-center lg:items-end lg:py-14 w-full order-1 lg:order-2 ">
              <div className="text-center text-white grid gap-8 max-w-[350px]">
                <motion.div
                ...
                >
                  ...
                  <h5>Loremvestibulum@gmail.com</h5>
                </motion.div>
                <motion.div
                ...
                >
                  ...
                  <h5>
                    Lorem ipsum dolor sit amet consectetur. Blandit quisque
                    dolor suspendisse feugiat. Consequat lacus ultrices volutpat
                    elit.
                  </h5>
                </motion.div>
              </div>
...
export default RoommatesContact;
