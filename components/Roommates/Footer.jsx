...
function Footer() {
  return (
    <div className="bg-black h-max relative bottom-0 font-inter text-white py-10">
      <div className="lg:flex font-normal lg:justify-evenly font-inter px-10 grid gap-5">
        <div className="">
          <h1 className=" lg:text-3xl text-2xl font-bold">
            99 Group of Companies
          </h1>

          <h3 className="opacity-60 pt-3">Transforming your life with ease</h3>
        </div>
        <div className="">
      ...
      <div className="flex lg:hidden justify-center items-center gap-x-3 py-5">
